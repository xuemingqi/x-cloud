...
public class WeChatServiceImpl implements WeChatService {
    ...
    @Override
    public BaseResult<String> getQrData(String state) {
        return ResultUtil.buildResultSuccess(ImgUtil.toBase64DataUri(getQrImage(state), ImgUtil.IMAGE_TYPE_PNG));
    }

    @Override
    @RedisLock(prefix = "WX_USER_INFO", suffix = {"#code", "#state"}, releaseTime = 10, waitTime = 10)
    public BaseResult<WxMpUser> userInfo(String code, String state) {
        ...
        throw new XException(ResponseCodeEnum.WX_GET_USER_INFO_ERROR);
    }
